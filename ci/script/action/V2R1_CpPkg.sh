...
sudo umount /mnt
sudo mount -t cifs -o username=Administrator,password=Huawei@123 //10.183.243.153/RDV2R1C20_AgentPackage /mnt
if [ $? -ne 0 ]
then
    echo "ERROR:mount //10.183.243.153/RDV2R1C20_AgentPackage to /mnt failed!"
    exit 1
fi

PKG_VERSION=`cat /home/icp/Agent/V2R1C20VersionNo.txt`
